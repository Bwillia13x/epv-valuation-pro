...
export const CalculationStepDisplay = ({
  step,
  theme,
}: {
  ...
  >
    ...
    <div
      className={cx(
        'text-xs font-mono p-2 rounded mb-2',
        theme === 'dark'
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
      ...
      <div>
        ...
        <div
          className={cx(
            'mt-1 p-2 rounded font-mono text-xs',
            theme === 'dark' ? 'bg-slate-900' : 'bg-slate-50'
          )}
        >
          {step.calculation}
...
export const AuditTrailDisplay = ({
  trail,
  theme,
}: {
...
export const FormulaReferenceDisplay = ({
  theme,
}: {
  theme: 'dark' | 'light';
}) => (
  ...
  >
    ...
    {Object.entries(formulaLibrary).map(([key, section]) => (
      <div key={key} className="mb-6">
        <h4 className="text-md font-semibold mb-3 text-emerald-400">
          {section.title}
        </h4>
        <div className="space-y-4">
          {section.formulas.map((formula, idx) => (
            ...
            >
              ...
              <div
                className={cx(
                  'text-sm font-mono p-2 rounded mb-2',
                  theme === 'dark'
                    ? 'bg-slate-900 text-green-400'
...
export const VerificationDisplay = ({
  ...
  >
    <h3 className="text-lg font-semibold mb-4">
      🔍 Calculation Verification & Cross-Checks
    </h3>
...
export const ExportControls = ({
  ...
  return (
    ...
    >
      <h3 className="text-lg font-semibold mb-4">
        📤 Export Calculation Documentation
      </h3>
