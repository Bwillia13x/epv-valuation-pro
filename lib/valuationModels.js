...
export function forecastTrendMA(values, periods = 5, volatilityScale = 0.3) {
    if (values.length < 2) {
...
export function calculateSynergies(baseRevenue, baseEBITDA, params) {
    let synergy = 0;
...
export function runMonteCarloEPV(input) {
